...
const footerLinks = {
  Services: ["Business Website", "E-Commerce Store", "Landing Page", "Website Redesign", "SEO Optimization"],
  Industries: ["Restaurants", "Schools", "Travel Agencies", "Retail Shops", "Startups", "Service Businesses"],
  Company: ["About", "Portfolio", "Testimonials", "Pricing", "Contact"],
};
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {socials.map((s) => (
                ...
                >
                  <s.icon className="w-4 h-4 text-slate-400 hover:text-white" />
                </a>
              ))}
            </div>
          </div>
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section}>
              ...
              <ul className="space-y-2.5">
                {links.map((l) => (
                  <li key={l}>
                    <a href="#" className="text-slate-400 text-sm hover:text-brand-400 transition-colors duration-200">
                      {l}
                    </a>
                  </li>
                ))}
